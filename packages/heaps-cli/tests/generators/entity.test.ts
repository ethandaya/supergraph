...
describe("Entity Generator", () => {
  ...
  let asyncGenerator: EntityGenerator;
  ...
  beforeEach(() => {
    ...
    asyncGenerator = new EntityGenerator({
      models: { test: TestSchema },
      outputPath,
      storeType: "async",
    });
  ...
  it("should generate the full type set", () => {
    ...
    expect(generator.targetFile.getFullText()).toMatchInlineSnapshot(`
      ...
      import { z } from \\"zod\\";
      import { Entity, KeyAccessError } from \\"@heaps/engine\\";
  ...
  it("should generate the async type set", () => {
    asyncGenerator.generate({
      shouldSave: false,
    });
    expect(asyncGenerator.targetFile.getFullText()).toMatchInlineSnapshot(`
      "// THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.
